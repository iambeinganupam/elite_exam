...
<nav class="navbar navbar-expand-lg sticky-top" style="background: black; height: 80px;">
  ...
  <!--<h3 style="color: cyan; margin-left: 1%;"><?php echo $pagename; ?></h3>-->
    ...
    <nav class="sidebar">
      <div class="text">Hello, <?php echo $_SESSION['org_username']; ?></div>
      <ul>
        <li>
        ...
        <li>
          <a href="mystudents.php"><i class="fa fa-graduation-cap"></i> Add Students</a>
        </li>

        <li>
          <a href="myexams.php"><i class="fa fa-id-card"></i> My Exams</a>
        </li>
